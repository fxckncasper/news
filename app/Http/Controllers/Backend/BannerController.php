...
class BannerController extends Controller
{
    ...
    public function UpdateBanners(Request $request)
    {
        ...
        if ($request->file('home_one')) 
        {
            ...
            @unlink(public_path($data->home_one));
        ...
        {
            $data = Banner::find($banner_id);
            @unlink(public_path($data->home_two));
        ...
        {
            $data = Banner::find($banner_id);
            @unlink(public_path($data->home_three));
        ...
        {
            $data = Banner::find($banner_id);
            @unlink(public_path($data->home_four));
        ...
        {
            $data = App\Models\Banner::find($banner_id);
            @unlink(public_path($data->news_category_one));
        ...
        {
            $data = Banner::find($banner_id);
            @unlink(public_path($data->news_details_one));
