            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" method="post" action="<?php echo e(route('permission.store')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/clients/client3/web3/private/udemy/Laravel9A-ZForBeginnerWithCompleteNewsPortalWebsite/news/app/resources/views/backend/pages/permission/add_permission.blade.php ENDPATH**/ ?>